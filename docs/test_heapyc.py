...
class Tester:
    ...
    def test_HeapView(self, arg):
        ...
        t22 = arg.register_hidden_exact_type(self.get_ex_5())
        t23 = arg.update_dictowners(self.get_ex_1())
        t24 = arg.update_referrers(self.get_ex_1(), self.get_ex_3())
        t25 = arg.update_referrers_completely(self.get_ex_1())
        t26 = arg.limitframe
